...
echo "docker run --user=$(id -u):$(id -g) -i -v $output_directory:/tmp cv_builder miktex-pdflatex /tmp/$tex_file --quiet --output-directory=/tmp --include-directory=/tmp --output-format=$output_format"
